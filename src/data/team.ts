...
export const teamMembers: TeamMember[] = [
    {
        ...
        bio: "James Liu is a freshman at Duke University that plans to pursue a career in healthcare.\n\nHe was the president of his school's HOSA chapter and qualified for the International Leadership Conference 3 times. He also is a dedicated researcher, conducting medical research at Cone Health Hospital, Wake Forest University, and UNC-Chapel Hill. At Cone Health, he published an abstract to the ASTRO red journal as second author.\n\nHe also serves as the NC Chapter President of Aerovate Tutoring, an organization that provides online subject tutoring and supports refugee children. James is a Duke Trinity Scholarship Finalist, National Merit Scholarship Semi-finalist, US. Presidential Scholarship Nominee, Robertson Scholarship Semi-finalist, and has a 1590 SAT score.",
    ...
    },
    {
        ...
        bio: "Ronit Dey is a freshman at Duke University with a strong background in technology, business, and advocacy.\n\nIn high school, he worked as an independent, pro-bono technology consultant, delivering over $500,000 worth of digital solutions to some of the nation's largest nonprofits—including Big Brothers Big Sisters. Passionate about public health education, Ronit spearheaded a statewide initiative to modernize sex education curricula across North Carolina, a project now being implemented in high schools with support from the Obama and Clinton foundations.\n\nRonit has also pursued competitive science research, focusing on computational methods, and earned recognition at both the state and national levels. In addition, he was a four-year competitor in FBLA and DECA, earning top placements at state and national competitions each year. Ronit was also accepted to the University of North Carolina at Chapel Hill Honors College as a Kenan-Flagler Assured Admit (1/75) and to Georgia Tech as a CS major. ",
    ...
    },
    {
        ...
        bio: "Shubhan is a freshman at the University of Pennsylvania, enrolled in the dual degree M&T Program across Wharton Business School and the School of Engineering and Applied Science, where he plans to study Electrical Engineering and Entrepreneurship with a focus on developing technologies that tackle global health accessibility challenges.\n\nA passionate researcher, ECNL-level soccer player, and accomplished cellist in orchestral and chamber settings, Shubhan is an ISEF Finalist, RISE for the World Global Finalist, and Earth Prize Global Award winner—earning $50,000 for his team's work. He has presented internationally, including in Switzerland, published a single-author IEEE paper on an autonomous drone to detect and treat malaria sites and won awards from governmental organizations such as USAID.\n\nHe was admitted to Columbia University, Carnegie Mellon University, Johns Hopkins University, Georgia Institute of Technology, Vanderbilt University, and the University of Illinois Urbana-Champaign.",
